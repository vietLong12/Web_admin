...
const _chalk = /*#__PURE__*/ _interop_require_default(__webpack_require__(54382));
...
const _staticgenerationbailout = __webpack_require__(99639);
class DraftMode {
    get isEnabled() {
...
const _requestcookies = __webpack_require__(56999);
const _headers = __webpack_require__(41107);
const _cookies = __webpack_require__(29302);
const _requestasyncstorage = __webpack_require__(26775);
const _actionasyncstorage = __webpack_require__(11742);
const _staticgenerationbailout = __webpack_require__(99639);
const _draftmode = __webpack_require__(30712);
function headers() {
...
let chalk;
if (false) {} else {
    chalk = __webpack_require__(93570);
}
...
const _headers = __webpack_require__(41107);
const _constants = __webpack_require__(25162);
function getCookieParser(headers) {
    return function parseCookie() {
        ...
        const { parse: parseCookieFn } = __webpack_require__(98810);
...
function clearPreviewData(res, options = {}) {
    ...
    const { serialize } = __webpack_require__(98810);
...
const _apiutils = __webpack_require__(8046);
...
const _approuterheaders = __webpack_require__(44892);
const _headers = __webpack_require__(41107);
const _requestcookies = __webpack_require__(56999);
const _cookies = __webpack_require__(29302);
const _draftmodeprovider = __webpack_require__(32810);
...
const _http = __webpack_require__(28789);
const _responsehandlers = __webpack_require__(53588);
...
function autoImplementMethods(handlers) {
    ...
    const missing = AUTOMATIC_ROUTE_METHODS.filter((method)=>!implemented.has(method)); // Loop over the missing methods to automatically implement them if we can.
    for (const method of missing){
        ...
        if (method === "HEAD") {
            ...
            // we're done.
            if (!handlers.GET) break; // Implement the HEAD method by calling the GET method.
...
function getPathnameFromAbsolutePath(absolutePath) {
    ...
    const relativePath = appDir[0] + parts.join(appDir); // remove extension
...
const _cookies = __webpack_require__(88167);
const _nexturl = __webpack_require__(73452);
const _cleanurl = __webpack_require__(91762);
...
const _notfound = __webpack_require__(45565);
const _redirect = __webpack_require__(60283);
const _responsehandlers = __webpack_require__(53588);
...
const _routemodule = __webpack_require__(48098);
const _requestasyncstoragewrapper = __webpack_require__(17713);
const _staticgenerationasyncstoragewrapper = __webpack_require__(69202);
const _responsehandlers = __webpack_require__(53588);
const _http = __webpack_require__(28789);
const _patchfetch = __webpack_require__(44611);
const _tracer = __webpack_require__(96039);
const _constants = __webpack_require__(82732);
const _getpathnamefromabsolutepath = __webpack_require__(5008);
const _proxyrequest = __webpack_require__(22654);
const _resolvehandlererror = __webpack_require__(44864);
const _log = /*#__PURE__*/ _interop_require_wildcard(__webpack_require__(48370));
const _autoimplementmethods = __webpack_require__(64152);
const _getnonstaticmethods = __webpack_require__(92655);
const _requestcookies = __webpack_require__(56999);
...
const { requestAsyncStorage } = __webpack_require__(26775);
const { staticGenerationAsyncStorage } = __webpack_require__(93027);
const serverHooks = __webpack_require__(61461);
const headerHooks = __webpack_require__(10741);
const { staticGenerationBailout } = __webpack_require__(99639);
const { actionAsyncStorage } = __webpack_require__(11742);
class AppRouteRouteModule extends _routemodule.RouteModule {
    ...
    */ this.actionAsyncStorage = actionAsyncStorage;
        ...
        this.nextConfigOutput = nextConfigOutput; // Automatically implement some methods if they aren't implemented by the
        // userland module.
        this.methods = (0, _autoimplementmethods.autoImplementMethods)(userland); // Get the non-static methods for this route.
        this.nonStaticMethods = (0, _getnonstaticmethods.getNonStaticMethods)(userland); // Get the dynamic property from the userland module.
  ...
  */ async execute(request, context) {
        ...
        const handler = this.resolve(request.method); // Get the context for the request.
        ...
        const response = await this.actionAsyncStorage.run({
            ...
            return _requestasyncstoragewrapper.RequestAsyncStorageWrapper.wrap(this.requestAsyncStorage, requestContext, ()=>{
                return _staticgenerationasyncstoragewrapper.StaticGenerationAsyncStorageWrapper.wrap(this.staticGenerationAsyncStorage, staticGenerationContext, (staticGenerationStore)=>{
                    ...
                    staticGenerationStore.revalidate ??= this.userland.revalidate ?? false; // Wrap the request so we can add additional functionality to cases
                    ...
                    return (0, _tracer.getTracer)().trace(_constants.AppRouteRouteHandlersSpan.runHandler, {
                        ...
                        var _staticGenerationStore_tags; // Patch the global fetch.
        ...
        if (response.headers.has("x-middleware-rewrite")) {
            ...
            throw new Error("NextResponse.rewrite() was used in a app route handler, this is not currently supported. Please remove the invocation to continue."); // // This is a rewrite created via `NextResponse.rewrite()`. We need to send
    ...
    async handle(request, context) {
        try {
            ...
            const response = await this.execute(request, context); // The response was handled, return it.
            return response;
        } catch (err) {
            // Try to resolve the error to a response, else throw it again.
            const response = (0, _resolvehandlererror.resolveHandlerError)(err);
            if (!response) throw err; // The response was resolved, return it.
            return response;
        }
    }
}
...
const _constants = __webpack_require__(82732);
const _tracer = __webpack_require__(96039);
const _constants1 = __webpack_require__(25162);
        ...
        return await (0, _tracer.getTracer)().trace(_constants.AppRenderSpan.fetch, {
            ...
            if (cacheKey && (staticGenerationStore == null ? void 0 : staticGenerationStore.incrementalCache)) {
                ...
                if ((entry == null ? void 0 : entry.value) && entry.value.kind === "FETCH") {
                    const currentTags = entry.value.data.tags; // when stale and is revalidating we wait for fresh data
                    ...
                    if (!(staticGenerationStore.isRevalidate && entry.isStale)) {
                        if (entry.isStale) {
                            ...
                            var _staticGenerationStore_incrementalCache; // if new tags are being added we need to set even if
            ...
            if (staticGenerationStore.isStaticGeneration) {
                if (init && typeof init === "object") {
                    const cache = init.cache; // Delete `cache` property as Cloudflare Workers will throw an error
                    if (isEdgeRuntime) {
                        delete init.cache;
                    }
                    if (cache === "no-store") {
...
const _constants = __webpack_require__(82732);
let api; // we want to allow users to use their own version of @opentelemetry/api if they
...
class NextTracerImpl {
  ...
  */ getTracerInstance() {
    ...
    trace(...args) {
        const [type, fnOrOptions, fnOrEmpty] = args; // coerce options form overload
        ...
        const spanName = options.spanName ?? type; // Trying to get active scoped span to assign parent. If option specifies parent span manually, will try to use it.
...
const _detectdomainlocale = __webpack_require__(95659);
const _formatnextpathnameinfo = __webpack_require__(81144);
const _gethostname = __webpack_require__(62600);
const _getnextpathnameinfo = __webpack_require__(39120);
...
const _reflect = __webpack_require__(48455);
    ...
    constructor(headers){
        ...
        this.headers = new Proxy(headers, {
            get (target, prop, receiver) {
                ...
                const lowercased = prop.toLowerCase(); // Let's find the original casing of the key. This assumes that there is
                // no mixed case keys (e.g. "Content-Type" and "content-type") in the
                // headers object.
                const original = Object.keys(headers).find((o)=>o.toLowerCase() === lowercased); // If the original casing doesn't exist, return undefined.
            ...
            set (target, prop, value, receiver) {
                ...
                // no mixed case keys (e.g. "Content-Type" and "content-type") in the
                // headers object.
                const original = Object.keys(headers).find((o)=>o.toLowerCase() === lowercased); // If the original casing doesn't exist, use the prop as the key.
            ...
            has (target, prop) {
                ...
                // no mixed case keys (e.g. "Content-Type" and "content-type") in the
                // headers object.
                const original = Object.keys(headers).find((o)=>o.toLowerCase() === lowercased); // If the original casing doesn't exist, return false.
            ...
            deleteProperty (target, prop) {
                ...
                // no mixed case keys (e.g. "Content-Type" and "content-type") in the
                // headers object.
                const original = Object.keys(headers).find((o)=>o.toLowerCase() === lowercased); // If the original casing doesn't exist, return true.
  ...
  */ static from(headers) {
    ...
    *entries() {
        for (const key of Object.keys(this.headers)){
            const name = key.toLowerCase(); // We assert here that this is a string because we got it from the
...
function appendMutableCookies(headers, mutableCookies) {
    ...
    const returnedCookies = resCookies.getAll(); // Set the modified cookies as fallbacks.
...
const _nexturl = __webpack_require__(73452);
const _utils = __webpack_require__(82970);
const _error = __webpack_require__(13713);
const _cookies = __webpack_require__(29302);
...
const _uaparserjs = /*#__PURE__*/ _interop_require_default(__webpack_require__(13683));
function _interop_require_default(obj) {
    return obj && obj.__esModule ? obj : {
        default: obj
    };
...
const _addpathprefix = __webpack_require__(1939);
const _pathhasprefix = __webpack_require__(50776);
...
const _parsepath = __webpack_require__(83792);
...
const _removetrailingslash = __webpack_require__(51199);
const _addpathprefix = __webpack_require__(1939);
const _addpathsuffix = __webpack_require__(48832);
const _addlocale = __webpack_require__(60835);
...
const _normalizelocalepath = __webpack_require__(22111);
const _removepathprefix = __webpack_require__(29058);
const _pathhasprefix = __webpack_require__(50776);
...
const serverExports = {
    NextRequest: (__webpack_require__(64531).NextRequest),
    NextResponse: (__webpack_require__(32652)/* .NextResponse */ .x),
    ImageResponse: (__webpack_require__(18700)/* .ImageResponse */ .E),
    userAgentFromString: (__webpack_require__(71031).userAgentFromString),
    userAgent: (__webpack_require__(71031).userAgent)
};
